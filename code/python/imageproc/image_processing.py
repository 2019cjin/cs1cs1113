...
def intensify(pixel,quantity):
    pixel0 = pixel[0] + quantity
    pixel1 = pixel[1] + quantity
    pixel2 = pixel[2] + quantity

    pixel[0] = inBounds (pixel0)
    pixel[1] = inBounds (pixel1)
    pixel[2] = inBounds (pixel2)
